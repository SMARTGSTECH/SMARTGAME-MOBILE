          ...
          child: Container(
            ...
            child: Container(
              ...
              child: ContainedTabBarView(
                ...
                tabs: [
                  Text('BNB', style: TextStyle(fontSize: 16.sp)),
                  Text('USDT', style: TextStyle(fontSize: 16.sp)),
                  Text(
                    'SOL',
                    style: TextStyle(fontSize: 16.sp),
                  ),
                  Text('BETK', style: TextStyle(fontSize: 16.sp)),
                ],
                views: [
                  /* -------------------------------------------------------------------------- */
                  /*                               Tab1                               */
                          ...
                          child: userWalletProvider.startedTransaction
                              ...
                              : Column(children: [
                                  ...
                                  !userWalletProvider.cryptoRate.isNotEmpty
                                      ? Text(
                                          "${userWallet.userConvertedStaked}  BNB",
                                          style: TextStyle(
                                              fontSize: 18.sp,

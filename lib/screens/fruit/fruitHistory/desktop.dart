...
import 'package:smartbet/screens/coin/coinhistory/historyTable.dart';
import 'package:smartbet/screens/fruit/fruitHistory/fruitapi.dart';
import 'package:smartbet/screens/fruit/fruitHistory/historyTable.dart';
...
import '../../../utils/config/size.dart';

class FruitHistoryScreen extends StatefulWidget {
  // const FruitHistoryScreen({Key? key}) : super(key: key);
  const FruitHistoryScreen({super.key, this.directLaunch = false});
  final bool directLaunch;

  @override
  State<FruitHistoryScreen> createState() => _FruitHistoryScreenState();
}

List names = ["18/20 - 2010", "Game Type", 'Status'];

class _FruitHistoryScreenState extends State<FruitHistoryScreen> {
  @override
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Expanded(child: FruitTable()),
                ],
              ),
            ),
          ),
...
class _myStakeWidgetState extends State<myStakeWidget> {
  late Future<List<FruitData>> futureData;

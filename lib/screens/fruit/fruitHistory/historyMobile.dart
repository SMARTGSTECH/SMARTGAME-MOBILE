...
class FruitHistoryMobile extends StatefulWidget {
  const FruitHistoryMobile({super.key, required this.isStake});
  final bool isStake;

  @override
  State<FruitHistoryMobile> createState() => _FruitHistoryMobileState();
}

class _FruitHistoryMobileState extends State<FruitHistoryMobile> {
  @override

...
class FruitTable extends StatefulWidget {
  const FruitTable({super.key});

  @override
  FruitsTableState createState() => FruitsTableState();
}

class FruitsTableState extends State<FruitTable> {
  List<String> headers = [];
  List<dynamic> dataList = [];

  Future<void> fetchData() async {
    try {
      final dynamic response = await ApiClientService.get('/fruit');

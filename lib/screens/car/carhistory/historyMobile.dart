...
class CarHistoryMobile extends StatefulWidget {
  const CarHistoryMobile({super.key, required this.isStake});
  final bool isStake;
  @override
  State<CarHistoryMobile> createState() => _CarHistoryMobileState();
}

class _CarHistoryMobileState extends State<CarHistoryMobile> {
  @override

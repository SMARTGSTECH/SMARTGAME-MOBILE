...
import 'package:smartbet/screens/dice/dicehistory/historyTable.dart';
...
class DiceHistoryScreen extends StatefulWidget {
  ...
  const DiceHistoryScreen({super.key, this.directLaunch = false});
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Expanded(child: DiceTable()),
                ],
              ),
            ),
          ),

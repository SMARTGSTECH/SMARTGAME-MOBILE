...
import 'package:smartbet/screens/dice/dicehistory/diceapi.dart';
...
class DiceHistoryMobile extends StatefulWidget {
  const DiceHistoryMobile({super.key, required this.isStake});
  final bool isStake;
  @override
  State<DiceHistoryMobile> createState() => _DiceHistoryMobileState();
}

class _DiceHistoryMobileState extends State<DiceHistoryMobile> {
  @override
...
class _myStakeWidgetState extends State<myStakeWidget> {
  late Future<List<DiceData>> futureData;
  late String wallet;
  ...
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<List<DiceData>>(
      future: futureData,
                  ...
                  .where((element) =>
                      ...
                      helper
                          .shortenWalletAddress(
                              userWallet.currentAddress ?? "0xde")
                          .toLowerCase())
                  .toList()
              : snapshot.data!;
          print(dataList);

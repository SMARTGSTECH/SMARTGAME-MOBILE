...
class DiceTable extends StatefulWidget {
  const DiceTable({super.key});

  @override
  _DiceTableState createState() => _DiceTableState();
}

class _DiceTableState extends State<DiceTable> {
  List<String> headers = [];
